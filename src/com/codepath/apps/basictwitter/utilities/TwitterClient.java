...
public class TwitterClient extends OAuthBaseClient {
	...
	public void getHomeTimeline(boolean bLoadMore, boolean bRefresh,
			AsyncHttpResponseHandler handler) {
	...
	public void getMentionsTimeline(boolean bLoadMore, boolean bRefresh,
			AsyncHttpResponseHandler handler) {
		DebugInfo.stackTrace();
...
//		}
	...
	public void getUserTimeline(boolean bLoadMore, boolean bRefresh, String userScreenName,
			AsyncHttpResponseHandler handler) {
		DebugInfo.stackTrace();
...
//		}
	...
	public void getSearchTimeline(boolean bLoadMore, boolean bRefresh, String searchText,
			AsyncHttpResponseHandler handler) {
		DebugInfo.stackTrace();
	...
	public void postRetweet(long id, AsyncHttpResponseHandler handler) {
		DebugInfo.stackTrace();
		String apiUrl = getApiUrl("statuses/retweet/" + String.valueOf(id)
				+ ".json");
